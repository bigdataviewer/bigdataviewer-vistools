...
public class BehaviourTransformEventHandlerSwitchable implements BehaviourTransformEventHandler< AffineTransform3D >
{
	...
	private final BehaviourTransformEventHandler3D handler3D;
	...
	public static class BehaviourTransformEventHandlerSwitchableFactory implements BehaviourTransformEventHandlerFactory< AffineTransform3D >
	{
		...
		@Override
		public BehaviourTransformEventHandlerSwitchable create( final TransformListener< AffineTransform3D > transformListener )
		{
			return new BehaviourTransformEventHandlerSwitchable( transformListener, config );
		}
	}

	public BehaviourTransformEventHandlerSwitchable( final TransformListener< AffineTransform3D > listener, final InputTriggerConfig config )
	{
		this.listener = listener;
		handler2D = new BehaviourTransformEventHandlerPlanar( listener, config );
		handler3D = new BehaviourTransformEventHandler3D( listener, config );
		current = handler3D;
	}
